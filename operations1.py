# __all__ = ['ConvNorm', 'BasicResidual1x', 'BasicResidual_downup_1x', 'BasicResidual2x', 'BasicResidual_downup_2x',
#            'FactorizedReduce', 'OPS', 'OPS_name', 'OPS_Class']
...
class BasicResidual1x(nn.Module):
    def __init__(self, C_in, C_out, kernel_size=3, stride=1, dilation=1, groups=1, slimmable=True, width_mult_list=[1.]):
        ...
        if slimmable:
            ...
            self.conv1 = nn.Conv2d(C_in, C_out, 3, stride, padding=dilation, dilation=dilation, groups=groups, bias=True)
            # self.bn1 = nn.BatchNorm2d(C_out)
            self.bn1 = BatchNorm2d(C_out, eps=1e-03, affine=True)
            # self.conv3x1_1 = nn.Conv2d(C_in, C_out, (3, 1), stride=1, padding=(1, 0), bias=True)
            # self.conv1x3_1 = nn.Conv2d(C_out, C_out, (1, 3), stride=1, padding=(0, 1), bias=True)
...
class BasicResidual_downup_1x(nn.Module):
    def __init__(self, C_in, C_out, kernel_size=3, stride=1, dilation=1, groups=1, slimmable=True, width_mult_list=[1.]):
        ...
        if slimmable:
            ...
            self.conv1 = nn.Conv2d(C_in, C_out, 3, 1, padding=dilation, dilation=dilation, groups=groups, bias=True)
            # self.bn1 = nn.BatchNorm2d(C_out)
            self.bn1 = BatchNorm2d(C_out, eps=1e-03, affine=True)
            # self.conv3x1_1 = nn.Conv2d(C_in, C_out, (3, 1), stride=1, padding=(1, 0), bias=True)
            # self.conv1x3_1 = nn.Conv2d(C_out, C_out, (1, 3), stride=1, padding=(0, 1), bias=True)
...
class BasicResidual2x(nn.Module):
    def __init__(self, C_in, C_out, kernel_size=3, stride=1, dilation=1, groups=1, slimmable=True, width_mult_list=[1.]):
        ...
        if self.slimmable:
            ...
            # self.bn1 = nn.BatchNorm2d(C_out)
            self.bn1 = BatchNorm2d(C_out, eps=1e-03, affine=True)
            self.conv2 = nn.Conv2d(C_out, C_out, 3, 1, padding=dilation, dilation=dilation, groups=groups, bias=True)
            # self.bn2 = nn.BatchNorm2d(C_out)
            self.bn2 = BatchNorm2d(C_out, eps=1e-03, affine=True)
            # self.conv3x1_1 = nn.Conv2d(C_in, C_out, (3, 1), stride=1, padding=(1, 0), bias=True)
            # self.conv1x3_1 = nn.Conv2d(C_out, C_out, (1, 3), stride=1, padding=(0, 1), bias=True)
            # self.bn1 = nn.BatchNorm2d(C_out, eps=1e-03)
            # self.conv3x1_2 = nn.Conv2d(C_out, C_out, (3, 1), stride=1, padding=(1, 0), bias=True)
            # self.conv1x3_2 = nn.Conv2d(C_out, C_out, (1, 3), stride=1, padding=(0, 1), bias=True)
